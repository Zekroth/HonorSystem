...
namespace HonorSystem.ApiControllers
{
    ...
    public class ItemsApiController : ControllerBase
    {
        ...
        public ItemsApiController(ZerodropContext context)
        {
            _context = context;
        }
        ...
        // GET: api/Items
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Item>>> GetItems([FromQuery] int pageNumber = 0, [FromQuery] int pageSize = 0)
        {
